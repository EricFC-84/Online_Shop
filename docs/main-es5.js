...
var AppComponent = /** @class */ (function () {
    function AppComponent(_servVirtualShop) {
...
var CarritoComponent = /** @class */ (function () {
    function CarritoComponent(_servVirtualShop) {
        this._servVirtualShop = _servVirtualShop;
    }
    CarritoComponent.prototype.back = function () {
        this._servVirtualShop.setView(this._servVirtualShop.previous);
    };
    CarritoComponent.prototype.checkout = function () {
        this._servVirtualShop.checkout();
    };
    CarritoComponent.prototype.reduceAmount = function (i) {
        this._servVirtualShop.reduceAmount(i);
    };
    CarritoComponent.prototype.increaseAmount = function (i) {
...
var CategoriasComponent = /** @class */ (function () {
    function CategoriasComponent(_servVirtualShop) {
        this._servVirtualShop = _servVirtualShop;
        this.listCategories = [];
        this.loadCat();
    }
    CategoriasComponent.prototype.loadCat = function () {
        /* this.listCategories = */
    ...
    CategoriasComponent.prototype.loadProd = function (id) {
        /* this.listCategories = */
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(_servVirtualShop) {
        this._servVirtualShop = _servVirtualShop;
    }
    ...
    NavbarComponent.prototype.loadProd = function (id) {
        /* this.listCategories = */
        this._servVirtualShop.getProducts(id);
    };
...
var ProductosComponent = /** @class */ (function () {
    function ProductosComponent(_servVirtualShop) {
        this._servVirtualShop = _servVirtualShop;
        this.carrito = [];
    }
    ProductosComponent.prototype.back = function () {
        this._servVirtualShop.setView("categories");
    };
    ProductosComponent.prototype.addCart = function (producto) {
        var alreadyAdded = this.carrito.indexOf(producto);
        if (alreadyAdded < 0) {
    ...
    ProductosComponent.prototype.checkout = function () {
...
var ServVirtualShopService = /** @class */ (function () {
    function ServVirtualShopService() {
        this.arrCategories = [];
        this.arrProducts = [];
        this.arrCart = [];
        this.totalCost = 0;
    ...
    ServVirtualShopService.prototype.updateCart = function (newCart) {
        this.arrCart = newCart;
    };
    ServVirtualShopService.prototype.numProducts = function () {
        var num = 0;
    ...
    ServVirtualShopService.prototype.loadCart = function (previousView) {
        this.view = "carrito";
    ...
    ServVirtualShopService.prototype.checkout = function () {
        this.httpPostAsync("https://cors-anywhere.herokuapp.com/https://myonlineshop.requestcatcher.com/test", this.afterSold);
    };
    ServVirtualShopService.prototype.afterSold = function (arrCart) {
        arrCart.splice(0, arrCart.length);
    };
    ServVirtualShopService.prototype.httpPostAsync = function (url, callback) {
        var _this = this;
        var body = JSON.stringify(this.arrCart);
        var xmlHttp = new XMLHttpRequest();
        xmlHttp.onreadystatechange = function () {
            if (xmlHttp.readyState == 4 && xmlHttp.status == 200) {
                callback(_this.arrCart);
            }
        };
        xmlHttp.open("POST", url, true); // true for asynchronous
        xmlHttp.send(body);
    };
    ServVirtualShopService.prototype.setView = function (newView) {
        this.view = newView;
        // console.log(this.view)
    };
    ServVirtualShopService.prototype.getCategories = function (url) {
        // console.log(url)
        this.httpGetAsync(url, this.loadCategories, this.arrCategories);
    };
    ServVirtualShopService.prototype.httpGetAsync = function (url, callback, arrItems) {
        var xmlHttp = new XMLHttpRequest();
        xmlHttp.onreadystatechange = function () {
            if (xmlHttp.readyState == 4 && xmlHttp.status == 200) {
    ...
    ServVirtualShopService.prototype.loadCategories = function (categoriesData, arrCategories) {
    ...
    ServVirtualShopService.prototype.getProducts = function (id) {
        this.arrProducts = [];
        var url = "https://raw.githubusercontent.com/JoseHervas/fullstack-bootcamp/master/Contents/01-Front-end/03-JavaScript/02-jQuery/03-AJAX/dummyShop/" + id + ".json";
        this.currentCategory = this.arrCategories[id - 1]["name"];
        this.httpGetAsync(url, this.loadProducts, this.arrProducts);
        this.view = "products";
    };
    ServVirtualShopService.prototype.loadProducts = function (productsData, arrProducts) {
        for (var i = 0; i < productsData["products"].length; i++) {
            arrProducts.push(productsData["products"][i]);
        }
    };
    ServVirtualShopService.prototype.reduceAmount = function (i) {
        if (this.arrCart[i]["amount"] > 0) {
            this.arrCart[i]["amount"]--;
            this.totalCost -= this.arrCart[i]["price"];
        }
    };
    ServVirtualShopService.prototype.increaseAmount = function (i) {
        this.arrCart[i]["amount"]++;
        this.totalCost += this.arrCart[i]["price"];
    };
